      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-8 grid gap-5">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <Card><CardHeader><div className="flex items-start justify-between gap-3"><div><CardTitle>Account</CardTitle><CardDescription>Your active DevPilot workspace.</CardDescription></div><UserRound className="size-5 text-muted-foreground" /></div></CardHeader><CardContent><dl className="space-y-3 text-sm"><div className="flex justify-between gap-4"><dt className="text-muted-foreground">Workspace</dt><dd className="font-medium">DevPilot workspace</dd></div><div className="flex justify-between gap-4"><dt className="text-muted-foreground">Plan</dt><dd className="font-medium">Pro workspace</dd></div><div className="flex justify-between gap-4"><dt className="text-muted-foreground">Usage</dt><dd className="font-medium">View dashboard</dd></div></dl></CardContent></Card>
          </div>
